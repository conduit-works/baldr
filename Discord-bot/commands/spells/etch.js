...
module.exports = {
  ...
  // console.log(caller_username)	
    ...
    // end data
    const finalVariable = `{ "username":"${lastCallerMessage.author.username}","timestamp":"${lastCallerMessage.createdTimestamp}","guildID":"${lastCallerMessage.guildId}","channelID":"${lastCallerMessage.channelId}","content":"${lastCallerMessage.content}" }`
