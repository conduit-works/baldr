...
module.exports = {
	...
	async execute(interaction) {
		...
		for (const item of reversedKeys) {
			...
			loopout += `{ "username":"${item[1].author.username}","timestamp":"${item[1].createdTimestamp}","guildID":"${item[1].guildId}","channelID":"${item[1].channelId}","content":"${item[1].content}" }`
